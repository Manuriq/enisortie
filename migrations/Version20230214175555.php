 ...
 */
final class Version20230214175555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant ADD campus_id INT DEFAULT NULL, ADD image VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant DROP campus_id, DROP image, DROP updated_at');
    }
}
