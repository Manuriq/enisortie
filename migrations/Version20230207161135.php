 ...
 */
final class Version20230207161135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT NOT NULL, ADD campus_id INT NOT NULL, ADD organisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP etat_id, DROP campus_id, DROP organisateur_id');
    }
}
